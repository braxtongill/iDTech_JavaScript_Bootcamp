...
function checkPageBounds(direction, imgWidth, pos, pageWidth) {
  if (direction == 0) {
   if ((pos+imgWidth) > pageWidth) {
     direction = 1;
     console.log("Turning left. Hit the right side of the screen.")
   }
    else {
      direction = 0;
      console.log("Turning right. Not on the right side of the screen.")
   }
  }
  if (direction == 1) {
    if ((pos) < 0) {
      direction = 0;
      console.log("Turning right. Hit the left side of the screen.")
    }
     else {
       direction = 1;
    }
